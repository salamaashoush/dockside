  ...
  fn all_commands() -> Vec<PaletteCommand> {
    vec![
      ...
      PaletteCommand {
        ...
        category: "Navigation",
        icon: IconName::GalleryVerticalEnd,
        action: PaletteAction::Navigate(CurrentView::Workloads),
      },
      PaletteCommand {
        id: "nav-pods",
        label: "Go to Pods",
      ...
      PaletteCommand {
        id: "nav-statefulsets",
        label: "Go to StatefulSets",
        shortcut: None,
        category: "Navigation",
        icon: IconName::GalleryVerticalEnd,
        action: PaletteAction::Navigate(CurrentView::StatefulSets),
      },
      PaletteCommand {
        id: "nav-daemonsets",
        label: "Go to DaemonSets",
        shortcut: None,
        category: "Navigation",
        icon: IconName::SquareTerminal,
        action: PaletteAction::Navigate(CurrentView::DaemonSets),
      },
      PaletteCommand {
        id: "nav-jobs",
        label: "Go to Jobs",
        ...
        action: PaletteAction::Navigate(CurrentView::Jobs),
      },
      PaletteCommand {
        id: "nav-cronjobs",
        label: "Go to CronJobs",
        shortcut: None,
        category: "Navigation",
        icon: IconName::Calendar,
        action: PaletteAction::Navigate(CurrentView::CronJobs),
      },
      PaletteCommand {
        id: "nav-networking",
        ...
        category: "Navigation",
        icon: IconName::Globe,
        action: PaletteAction::Navigate(CurrentView::Networking),
      },
      PaletteCommand {
        id: "nav-services",
      ...
      PaletteCommand {
        id: "nav-ingresses",
        label: "Go to Ingresses",
        shortcut: None,
        category: "Navigation",
        icon: IconName::Globe,
        action: PaletteAction::Navigate(CurrentView::Ingresses),
      },
      PaletteCommand {
        id: "nav-pvcs",
        label: "Go to PersistentVolumeClaims",
        shortcut: None,
        category: "Navigation",
        icon: IconName::Folder,
        action: PaletteAction::Navigate(CurrentView::Pvcs),
      },
      PaletteCommand {
        id: "nav-config",
        label: "Go to Config (ConfigMaps + Secrets)",
        shortcut: Some("Cmd+8"),
        category: "Navigation",
        icon: IconName::Settings,
        action: PaletteAction::Navigate(CurrentView::Config),
      },
      PaletteCommand {
        id: "nav-configmaps",
        ...
        category: "Navigation",
        icon: IconName::Settings,
        action: PaletteAction::Navigate(CurrentView::ConfigMaps),
      },
      PaletteCommand {
        id: "nav-secrets",
        label: "Go to Secrets",
        ...
        action: PaletteAction::Navigate(CurrentView::Secrets),
      },
      PaletteCommand {
        id: "nav-machines",
      ...
      PaletteCommand {
        ...
        category: "Navigation",
        icon: IconName::Bot,
        action: PaletteAction::Navigate(CurrentView::Models),
      },
      PaletteCommand {
        id: "nav-activity",
